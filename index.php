            ...
            <div class="card">
                ...
                <form class="p-4" method="POST" action="registrar.php">
                    <div class="mb-3">
                        ...
                        <input type="text" placeholder="Ingrese su nombre" class="form-control" name="txtNombre" autofocus required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Edad: </label>
                        <input type="number" placeholder="Ingrese su Edad" class="form-control" name="txtEdad" autofocus required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Curso: </label>
                        <input type="text" placeholder="Ingrese el curso" class="form-control" name="txtCurso" autofocus required>
                    </div>
                    <div class="d-grid">
